...
С июля 2026 года — backend-разработчик на стажировке в **Яндексе**, команда **Яндекс Про · Driver Online / Orders**. Разрабатываю сервисы водительского цикла заказа. Учусь на программной инженерии в **НИУ ВШЭ**.

[Telegram](https://t.me/KarnaukhovGA) · [karnaukhovglebwork@gmail.com](mailto:karnaukhovglebwork@gmail.com)

## Опыт

В Яндексе работаю над надёжностью сервисов и интеграциями:

- Повышаю устойчивость API к ошибкам зависимых сервисов и добавляю управление источниками данных через конфигурацию.
- Переношу логику из C++-сервиса в AppHost, развиваю API, интеграции и тесты.
...
| Данные и очереди | PostgreSQL, SQL, RabbitMQ, YTsaurus |
| Инструменты и тестирование | Docker, Docker Compose, Git, pytest, unit-тесты, CI/CD |
...
**Go · Kafka · gRPC · Protobuf · Prometheus · Docker Compose**
...
**Go · PostgreSQL · REST · Docker Compose**
